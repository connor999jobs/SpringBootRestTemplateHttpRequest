package com.example.springbootresttemplatehttprequest;

import com.example.springbootresttemplatehttprequest.model.Post;
import com.example.springbootresttemplatehttprequest.servise.RestService;
...
public class SpringBootRestTemplateHttpRequestApplication implements CommandLineRunner {

    private RestService restService;

    public SpringBootRestTemplateHttpRequestApplication(RestService restService) {
        this.restService = restService;
    }

    public static void main(String[] args) {
        SpringApplication.run(SpringBootRestTemplateHttpRequestApplication.class, args);
    }
